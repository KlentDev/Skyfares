(function () {
  ...
  async function subscribeEmail(email, name, statusEl, btnEl, wrapperEl) {
    // Capture innerHTML, not textContent -- some buttons (e.g. the waitlist
    // form) contain an icon element alongside the label. textContent would
    // flatten and permanently discard it on the first restore.
